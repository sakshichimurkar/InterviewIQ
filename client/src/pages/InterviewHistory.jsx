...
function InterviewHistory() {
  ...
  useEffect(() => {
    const getMyInterviews = async () => {
      try {
        ...
        setInterview(Array.isArray(result.data) ? result.data : []);
      } catch (error) {
        setHistoryError(error.response?.data?.message || "Unable to load interview history.");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div
      className="min-h-screen bg-liner-to-br from-gray-50
    to-emerald-50 py-10"
    >
      <div className="w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-red-50 p-10 rounded-2xl shadow text-center">
