...
transition={{ duration: 0.8}}
    className="text-gray-500 mt-6 max-w-2x1 mx-auto text-lg  ">
...
items-center gap-10 mb-28">
  {
    [
      ...
      className={`
      relative bg-white rounded-xl border-2 border-green-100
      ...
      `}>
        ...
        border-2 border-green-500 text-green-600 w-16 h-16 rounded-xl flex
...
animate={{ opacity:1, y:0}}
transition={{ duration: 0.6}}
className="text-4x1 font-semibold text-center mb-16">
Advanced AI{" "}
