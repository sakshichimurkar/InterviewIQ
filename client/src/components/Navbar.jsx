...
//how to access user data useselector
...
try{
  ...
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
        ...
        shadow-sm border border-gray-200 px-8 flex justify-between 
...
<div className='flex items-center gap-6 relative'>
  ...
  <div className='relative'>
    ...
    <button onClick={() => {
     ...
     {showCreditPopup && (
        <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-x1 border 
        border-gray-200 rounded p-5 z-50'>
            <p className='text-sm text-gray-600 mb-4'>Need more credits to continue interviews?</p>
            <button onClick={()=>navigate("/pricing")} className='w-full bg-black text-white py-2 
