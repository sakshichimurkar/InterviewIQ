...
{
  /* have to create api for history get*/
}
...
const downloadPDF = () => {
  ...
  doc.setFontSize(11);
  doc.text(doc.splitTextToSize(advice, contentWidth - 20), margin + 10, currentY + 20);
  currentY += 50;
...
doc.save("AI_Interview_Report.pdf");
  ...
  return (<div className="min-h-screen bg-liner-to-br from-gray-50
  to-green-50 px-4 sm:px-6 lg:px-10 py-8">
    ...
    sm:justify-between gap-4">
      ...
      <div
                onClick={() => navigate("/")}
                className="md:mb-10 w-full flex items-start gap-4 flex-wrap"
              >
                <button
...
text-gray-400 mt-3 text-xs sm:text-sm">
Out of 10
</p>
...
<div className="lg:col-span-2 space-y-6">
  ...
  p-5 sm:p-8">
    ...
    <h3 className="text-base sm:text-lg font-semibold text-gray-700
    mb-4 sm:mb-6">Performance Trend
</h3>
